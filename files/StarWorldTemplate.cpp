...
// Hue shift for biome-related mods
MaterialHue WorldTemplate::biomeModHueShift(BiomeIndex biomeIndex, ModId mod) const {
  ...
  // Apply hue shift to any biome surface/underground mod
  bool isBiomeMod =
      mod == biome->surfacePlaceables.grassMod ||
      mod == biome->surfacePlaceables.ceilingGrassMod ||
